 ...
 * 极光推送demo主页面
 */
public class MainPushDemoActivity extends InstrumentedActivity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.init:
			...
			break;
		case R.id.setting:
			Intent intent = new Intent(MainPushDemoActivity.this, PushSetActivity.class);
